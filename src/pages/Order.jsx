...
function ClientInfos({ order }) {
  return (
    <Container>
      <Grid container flexDirection="column" gap={2}>
        <Typography variant="h4">Cliente</Typography>
        <Typography>
          Nome: <b>{order?.user?.fullName}</b>
        </Typography>
        <Typography>
          E-mail: <b>{order?.user?.email}</b>
        </Typography>
        <Typography>
          Data de nascimento:{' '}
          <b>{moment(order?.user?.birth).format('DD/MM/YYYY')}</b>
        </Typography>
        <Typography>
          Membro desde:{' '}
          <b>{moment(order?.user?.createdAt).format('DD/MM/YYYY')}</b>
        </Typography>
      </Grid>
    </Container>
  );
